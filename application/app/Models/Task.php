...
class Task extends Model {
    ...
    /**
     * relatioship business rules:
     *         - the Task can have one WhatsApp Ticket
     *         - the WhatsApp Ticket belongs to one Task
     */
    public function whatsappTicket() {
        return $this->hasOne('App\Models\WhatsappTicket', 'whatsappticket_taskid', 'task_id');
    }
