...
class Client extends Model {
    ...
    /**
     * relatioship business rules:
     *         - the Client can have one WhatsApp Contact
     *         - the WhatsApp Contact belongs to one Client
     */
    public function whatsappContact() {
        return $this->hasOne('App\Models\WhatsappContact', 'whatsappcontact_clientid', 'client_id');
    }

    /**
     * relatioship business rules:
     *         - the Client can have many WhatsApp Tickets
     *         - the WhatsApp Ticket belongs to one Client
     */
    public function whatsappTickets() {
        return $this->hasMany('App\Models\WhatsappTicket', 'whatsappticket_clientid', 'client_id');
    }

    /**
     * relatioship business rules:
     *         - the Client can have many Feedbacks
     *         - the Feedback belongs to one Client
     */
    public function feedbacks() {
        return $this->hasMany('App\Models\Feedback', 'client_id', 'client_id');
    }
     ...
     *         - the Ticket belongs to one Client
     */
    public function clientExpectations() {
        return $this->hasMany('App\Models\ClientExpectation', 'client_id', 'client_id');
    }
