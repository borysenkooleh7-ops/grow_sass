...
class Kernel extends ConsoleKernel {
    ...
    protected function schedule(Schedule $schedule) {
        ...
        //[whatsapp] - Update SLA status and check for breaches
        $schedule->job(new \App\Jobs\UpdateSlaStatusJob)
            ->everyFiveMinutes()
            ->name('whatsapp-sla-update')
            ->withoutOverlapping();

        //[whatsapp] - Process scheduled broadcasts
        $schedule->command('whatsapp:process-scheduled-broadcasts')
            ->everyMinute()
            ->name('whatsapp-scheduled-broadcasts')
            ->withoutOverlapping();
