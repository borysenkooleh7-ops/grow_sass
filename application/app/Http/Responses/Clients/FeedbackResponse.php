...
class FeedbackResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //render the form
        $html = view('pages/client/components/tabs/feedback', compact('page', 'feedbacks','client', 'tags'))->render();
        $jsondata['dom_html'][] = [
