            ...
            <ul id="sidebarnav" data-modular-id="main_menu_team">
               ...
               <!--projects-->
                ...
                <li data-modular-id="main_menu_team_whatsapp"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li class="sidenav-submenu {{ $page['submenu_whatsapp_conversations'] ?? '' }}" id="submenu_whatsapp_conversations">
                            <a href="{{ url('/whatsapp/conversations') }}"
                                class="{{ $page['submenu_whatsapp_conversations'] ?? '' }}">{{ cleanLang(__('lang.conversations')) }}</a>
                        </li>
                        <li class="sidenav-submenu {{ $page['submenu_whatsapp_qrscan'] ?? '' }}" id="submenu_whatsapp_qrscan">
                            <a href="{{ url('/whatsapp/qr-scan') }}"
                                class="{{ $page['submenu_whatsapp_qrscan'] ?? '' }}">
                                <i class="mdi mdi-qrcode-scan"></i> {{ cleanLang(__('lang.qr_scan')) ?? 'QR Scan' }}
                            </a>
                        </li>
                        <li class="sidenav-submenu {{ $page['submenu_whatsapp_templates'] ?? '' }}" id="submenu_whatsapp_templates">
                            <a href="{{ url('/whatsapp/templates/manage') }}"
                                class="{{ $page['submenu_whatsapp_templates'] ?? '' }}">{{ cleanLang(__('lang.templates')) }}</a>
                        </li>
                        <li class="sidenav-submenu {{ $page['submenu_whatsapp_quick_replies'] ?? '' }}" id="submenu_whatsapp_quick_replies">
                            <a href="{{ url('/whatsapp/quick-replies') }}"
                                class="{{ $page['submenu_whatsapp_quick_replies'] ?? '' }}">{{ cleanLang(__('lang.quick_replies')) }}</a>
                        </li>
                        <li class="sidenav-submenu {{ $page['submenu_whatsapp_broadcasts'] ?? '' }}" id="submenu_whatsapp_broadcasts">
                            <a href="{{ url('/whatsapp/broadcasts') }}"
                                class="{{ $page['submenu_whatsapp_broadcasts'] ?? '' }}">{{ cleanLang(__('lang.broadcasts')) }}</a>
                        </li>
                        <li class="sidenav-submenu {{ $page['submenu_whatsapp_automation'] ?? '' }}" id="submenu_whatsapp_automation">
                            <a href="{{ url('/whatsapp/automation') }}"
                                class="{{ $page['submenu_whatsapp_automation'] ?? '' }}">{{ cleanLang(__('lang.automation')) }}</a>
                        </li>
                    </ul>
                </li>
                <!--whatsapp-->
