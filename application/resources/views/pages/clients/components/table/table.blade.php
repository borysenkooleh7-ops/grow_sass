                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="col_ai_analysis {{ config('table.tableconfig_column_29') }} tableconfig_column_29" title="AI Analysis">
                                <i class="fa-solid fa-wand-magic-sparkles" data-toggle="tooltip" data-placement="top" title="AI Analysis"></i>
                            </th>
                            @endif
                            ...
                            <th
                                class="col_account_owner {{ config('table.tableconfig_column_3') }} tableconfig_column_3">
                            ...
                            @if (config('visibility.modules.contracts') && config('visibility.role_contracts'))
                                <th
                                    class="col_sum_contracts {{ config('table.tableconfig_column_18') }} tableconfig_column_18">
                            ...
                            <th
                                class="col_count_users {{ config('table.tableconfig_column_22') }} tableconfig_column_22">
                                <a class="js-ajax-ux-request js-list-sorting" id="sort_count_users"
                                    href="javascript:void(0)"
                            ...
                            <th
                                class="clients_col_tags {{ config('table.tableconfig_column_23') }} tableconfig_column_23">
                                <a href="javascript:void(0)">{{ cleanLang(__('lang.tags')) }}</a>
                            </th>

                            <!--tableconfig_column_24 [category]-->
                            <th
                                class="col_category {{ config('table.tableconfig_column_24') }} tableconfig_column_24">
                            ...
                            <th
                                class="col_expectation_fulfillment {{ config('table.tableconfig_column_26') }} tableconfig_column_26">
                                <a class="js-ajax-ux-request js-list-sorting" id="sort_expectation_fulfillment"
                                    href="javascript:void(0)"
                                    data-url="{{ urlResource('/clients?action=sort&orderby=expectation_fulfillment&sortorder=asc') }}">
                                    {{ cleanLang(__('lang.expectativas')) }}<span class="sorting-icons"><i
                                            class="ti-arrows-vertical"></i></span></a>
                            </th>
                            <th
                                class="col_average_feedback {{ config('table.tableconfig_column_27') }} tableconfig_column_27">
                                <a class="js-ajax-ux-request js-list-sorting" id="sort_average_feedback"
                                    href="javascript:void(0)"
                                    data-url="{{ urlResource('/clients?action=sort&orderby=average_feedback&sortorder=asc') }}">
                                    {{ cleanLang(__('lang.feedback')) }}<span class="sorting-icons"><i
                                            class="ti-arrows-vertical"></i></span></a>
                            </th>
                            <th
                                class="col_health_stats {{ config('table.tableconfig_column_28') }} tableconfig_column_28">
                                <a class="js-ajax-ux-request js-list-sorting" id="health_status"
                                    href="javascript:void(0)"
                                    data-url="{{ urlResource('/clients?action=sort&orderby=health_status&sortorder=asc') }}">
                                    {{ cleanLang(__('lang.health')) }}<span class="sorting-icons"><i
                                            class="ti-arrows-vertical"></i></span></a>
                            </th>
