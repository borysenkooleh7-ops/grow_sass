...
<ul class="nav nav-tabs profile-tab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link  tabs-menu-item js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_notes'] ?? '' }}"
            ...
            data-loading-target="embed-content-container"
            data-dynamic-url="{{ url('clients') }}/{{ $client->client_id }}/expectativas"
            data-url="{{ _url('/clients') }}/{{ $client->client_id }}/client-expectativas"
            href="#clients_ajaxtab" role="tab">{{ cleanLang(__('lang.expectativas')) }}</a>
    </li>
    <li class="nav-item">
        <a class="nav-link  tabs-menu-item js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_notes'] ?? '' }}"
            id="tabs-menu-feedback" data-toggle="tab" data-loading-class="loading-tabs"
            data-loading-target="embed-content-container"
            data-dynamic-url="{{ url('clients') }}/{{ $client->client_id }}/feedback"
            data-url="{{ _url('/clients') }}/{{ $client->client_id }}/client-feedback"
            href="#clients_ajaxtab" role="tab">{{ cleanLang(__('lang.feedback')) }}</a>
    </li>
    <li class="nav-item">
        <a class="nav-link  tabs-menu-item js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_notes'] ?? '' }}"
            id="tabs-menu-clientai" data-toggle="tab" data-loading-class="loading-tabs"
            data-loading-target="embed-content-container"
    ...
    <!--WhatsApp Tab-->
    <li class="nav-item">
        <a class="nav-link tabs-menu-item js-ajax-ux-request {{ $page['tabmenu_whatsapp'] ?? '' }}"
            id="tabs-menu-whatsapp" data-toggle="tab" data-loading-class="loading-tabs"
            data-loading-target="embed-content-container"
            data-url="{{ url('clients') }}/{{ $client->client_id }}/client-whatsapp"
            href="#clients_ajaxtab" role="tab">
            <i class="fab fa-whatsapp text-success mr-2"></i>{{ cleanLang(__('lang.whatsapp')) }}
        </a>
    </li>
