            ...
            <ul id="sidebarnav">
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="javascript:void(0);" data-url="/settings/feedback"
                                id="settings-menu-clients-feedback-templates"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url">{{ cleanLang(__('lang.feedback')) }}</a>
                        </li>
                        <!--[MODULES] - dynamic menu-->
